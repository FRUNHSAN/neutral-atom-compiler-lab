...
> 2026-07-22。脚本: `experiments/paper_compare.py`。CSV: `application/reproduction_diff.csv`。

| Benchmark | Paper F_wo_1q | Our F_wo_1q | Δ | 状态 |
|---|---|---|---|---|
| adder_n4 | 0.93 | 0.9203 | -0.010 | 视觉误差内 |
| qaoa_n6 | 0.76 | 0.7650 | +0.005 | 视觉误差内 |
| **qft_n10** | **0.541** | **0.5298** | **-0.011** | **论文显式值，δ=-2.1%** |
| sat_n11 | 0.10 | 0.0945 | -0.006 | 视觉误差内 |
| bv_n14 | 0.86 | 0.8622 | +0.002 | 视觉误差内 |
| multiplier_n15 | 0.10 | 0.0904 | -0.010 | 视觉误差内 |
| qnn_n15 | 0.47 | 0.4784 | +0.008 | 视觉误差内 |
| vqc_n15 | 0.03 | 0.0172 | -0.013 | 视觉误差内 |
| qram_n20 | 0.38 | 0.3823 | +0.002 | 视觉误差内 |
| knn_n25 | 0.34 | 0.3359 | -0.004 | 视觉误差内 |
| ising_n26 | 0.68 | 0.6783 | -0.002 | 视觉误差内 |
| wstate_n27 | 0.52 | 0.5074 | -0.013 | 视觉误差内 |
| ghz_n30 | 0.66 | 0.6548 | -0.005 | 视觉误差内 |
| cat_n35 | 0.58 | 0.5766 | -0.003 | 视觉误差内 |

**结论**：13/13 可视读值在 ±0.02 内。唯一精确值 qft_n10 δ=-2.1%（qiskit 版本差异）。

**ZAP vs ZAC 排名验证**：ZAP > ZAC 13/14（cat_n35 ZAC 略高 0.004，ZAC 二次 transpile 口径差异）。
