...
> 面向 BAQIS 2026 "量子青年人才储备计划"，目标导师：胡孟军。
...
**核心发现**：6 个决策点中 5 个已达 fidelity 平台期，只有 keep-vs-move（空闲比特留在纠缠区还是搬回存储区）存在结构性优化空间——硬阈值在 slot 紧约束下系统性失效（168 次违反），联合优化版本消除所有违反。
...
python experiments/tight_slot_compare.py     # 紧 slot 压力测试 (168→0)
...
| 紧 slot (3 for 20q) | **168 violations** | **0 violations** | 168→0 |
...
│   ├── tight_slot_compare.py   紧 slot 压力测试 (168→0)
